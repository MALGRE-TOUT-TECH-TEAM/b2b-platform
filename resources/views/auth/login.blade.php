    ...
    <div class="login-box ">
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="login-register">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-3 login-col "><a style="font-weight: 700" href="{{ route('login') }}">{{ __('LOG IND') }}</a></div>
                        <div class="col-md-9 opret-col"><a href="{{ route('register') }}">{{ __('OPRET KONTO') }}</a></div>
                    </div>
